      ...
      dtUserTable.DataTable({
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              var $role = full['role'];
              var roleBadgeObj = {
                Administrador: feather.icons['award'].toSvg({ class: 'font-medium-3 text-primary me-50' }),
                Directivo: feather.icons['slack'].toSvg({ class: 'font-medium-3 text-warning me-50' }),
                Comisionista: feather.icons['airplay'].toSvg({ class: 'font-medium-3 text-success me-50' }),
                Mecánico: feather.icons['settings'].toSvg({ class: 'font-medium-3 text-info me-50' }),
                Mensajero: feather.icons['slack'].toSvg({ class: 'font-medium-3 text-danger me-50' })
              };
        ...
        buttons: [
          ...
          },
          {
            ...
            className: 'add-new btn btn-add-user',
            attr: {
